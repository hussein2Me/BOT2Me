...
async def info(event):
    await event.edit("`جاري تحليل الدردشة ...`")
    ...
    try:
        ...
        print("Exception:", e)
        await event.edit("`لقد حدث خطأ غير متوقع.`")
    return
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`قناة / مجموعة غير صالحة`")
            return None
        except ChannelPrivateError:
            await event.edit("`هذه قناة / مجموعة خاصة أو ممنوع من هناك`")
            return None
        except ChannelPublicGroupNaError:
            await event.edit("`القناة أو المجموعة الفائقة غير موجودة`")
            return None
