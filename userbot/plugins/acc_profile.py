...
async def _(event):
    ...
    try:
        ...
        await event.edit("نجحت في تغيير السيرة الذاتية لملفي الشخصي")
...
async def _(event):
    ...
    try:
        ...
        await event.edit("تم تغيير اسمي بنجاح")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))
...
async def _(event):
    ...
    await event.edit("تحميل صورة الملف الشخصي...")
    ...
    try:
        ...
        if photo:
            ...
            try:
                ...
                await event.edit("تم تغيير صورة ملفي الشخصي بنجاح")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
